...
public class DatabendStatement extends TrivialStatement {
    ...
    public ResultSet executeQuery(String sql) throws SQLException {
        ...
        try {
            ...
            RowIterator iterator = nativeConnection.query(sql);
            currentResultSet = new DatabendResultSet(this, null,iterator);
    ...
    public boolean execute(String sql) throws SQLException {
        ...
        try {
            NativeConnection nativeConnection = connection.getNativeConnection();
            long count = nativeConnection.exec(sql);
    ...
    // Other JDBC methods with default implementations...
} 