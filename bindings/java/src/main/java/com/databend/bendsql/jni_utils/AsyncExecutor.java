...
/**
 * AsyncExecutor represents an underneath executor that runs async tasks spawned in the Rust world.
 *
 * <p>If the executor is passed to construct clients, the executor must outlive the clients.</p>
 */
